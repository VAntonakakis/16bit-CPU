...
-- *****************************************************************************
-- Generated on "03/28/2026 17:58:40"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          MyAnd16bit
-- 
...
ENTITY MyAnd16bit_vhd_vec_tst IS
END MyAnd16bit_vhd_vec_tst;
ARCHITECTURE MyAnd16bit_arch OF MyAnd16bit_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL A : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL B : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL Q : STD_LOGIC_VECTOR(15 DOWNTO 0);
COMPONENT MyAnd16bit
	PORT (

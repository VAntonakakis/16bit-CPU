...
ARCHITECTURE structure OF MyAnd16bit IS
...
-- Equation(s):
-- \v0|Q~combout\ = ( \A[0]~input_o\ & ( \B[0]~input_o\ ) )
...
-- Equation(s):
-- \v1|Q~combout\ = ( \B[1]~input_o\ & ( \A[1]~input_o\ ) )
...
-- Equation(s):
-- \v2|Q~combout\ = ( \B[2]~input_o\ & ( \A[2]~input_o\ ) )
...
-- Equation(s):
-- \v3|Q~combout\ = ( \A[3]~input_o\ & ( \B[3]~input_o\ ) )
...
-- Equation(s):
-- \v4|Q~combout\ = ( \B[4]~input_o\ & ( \A[4]~input_o\ ) )
...
-- Equation(s):
-- \v5|Q~combout\ = ( \A[5]~input_o\ & ( \B[5]~input_o\ ) )
...
-- Equation(s):
-- \v6|Q~combout\ = ( \B[6]~input_o\ & ( \A[6]~input_o\ ) )
...
-- Equation(s):
-- \v7|Q~combout\ = ( \B[7]~input_o\ & ( \A[7]~input_o\ ) )
...
-- Equation(s):
-- \v8|Q~combout\ = ( \A[8]~input_o\ & ( \B[8]~input_o\ ) )
...
-- Equation(s):
-- \v9|Q~combout\ = ( \B[9]~input_o\ & ( \A[9]~input_o\ ) )
...
-- Equation(s):
-- \v10|Q~combout\ = ( \A[10]~input_o\ & ( \B[10]~input_o\ ) )
...
-- Equation(s):
-- \v11|Q~combout\ = ( \B[11]~input_o\ & ( \A[11]~input_o\ ) )
...
-- Equation(s):
-- \v12|Q~combout\ = ( \B[12]~input_o\ & ( \A[12]~input_o\ ) )
...
-- Equation(s):
-- \v13|Q~combout\ = ( \A[13]~input_o\ & ( \B[13]~input_o\ ) )
...
-- Equation(s):
-- \v14|Q~combout\ = ( \A[14]~input_o\ & ( \B[14]~input_o\ ) )
...
-- Equation(s):
-- \v15|Q~combout\ = ( \B[15]~input_o\ & ( \A[15]~input_o\ ) )

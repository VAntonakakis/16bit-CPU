...
-- Q	=>  Location: PIN_P6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF MyOr4 IS
...
-- Equation(s):
-- \Q~0_combout\ = ( \D~input_o\ & ( \A~input_o\ ) ) # ( !\D~input_o\ & ( \A~input_o\ ) ) # ( \D~input_o\ & ( !\A~input_o\ ) ) # ( !\D~input_o\ & ( !\A~input_o\ & ( (\C~input_o\) # (\B~input_o\) ) ) )

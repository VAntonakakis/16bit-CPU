...
component MyExtend12to16 is port (
...
begin
	v0 : MyExtend12to16 port map (jumpAD,extended );
   multed(0)  <= '0';
   multed(1)  <= extended(0);
   multed(2)  <= extended(1);
   multed(3)  <= extended(2);
   ...
   v1 : MyFullAdder16bit port map (multed, instrP2AD,'0', EjumpAD, dummyCout);
end Structural;
...
-- Q	=>  Location: PIN_T7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- C	=>  Location: PIN_U6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF MyOr3 IS
...
-- Equation(s):
-- \Q~0_combout\ = ( \C~input_o\ ) # ( !\C~input_o\ & ( (\A~input_o\) # (\B~input_o\) ) )
